...
import { NorthWestList } from "./NorthWestList";

const NorthWest = () => {
  return (
    <>
      <div
        className="flex flex-wrap m-1 p-2 bg-green-800 rounded-md justify-center text-md 
