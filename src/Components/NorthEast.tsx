...
import { NorthEastList } from "./NorthEastList";

const NorthEast = () => {
  return (
    <>
      <div
        className="flex flex-wrap m-1 p-2 bg-red-700 rounded-md justify-center text-md 
