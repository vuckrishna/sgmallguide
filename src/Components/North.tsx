...
const North = () => {
  return (
    <>
      <div
        className="flex flex-wrap m-1 p-2 bg-teal-800 rounded-md justify-center text-md 
            ...
            return (
              <li className="justify-items-center">
                <a href={mall.link} className="justify-center">
                  ...
                  <div className="justify-items-center bg-gray-300 m-2 p-4 rounded-lg xxs:m-1 xxs:w-40 xxs:text-sm xs:w-44 xs:text-base xl:rounded-xl xl:text-lg font-medium xl:p-2 xl:w-56 xl:h-30">
                    <img
                      src={mall.pic}
                      alt=""
